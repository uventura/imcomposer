...
namespace UI {
Canvas::Canvas(const std::string& widgetPath, const int id)
    : widgetPath_(widgetPath), id_(id) {
  widgetInstance_ =
      std::make_unique<Core::Parser::JsonWidgetReader>(widgetPath);
}
...
void Canvas::draw() {
  ...
  ImGui::PushStyleColor(ImGuiCol_ChildBg,
                        ImVec4(0.23921568627450981, 0.23921568627450981,
                               0.23921568627450981, 1.0f));
